...
//                                             tvecs);
        ...
        if(markerIds.size() > 0)
        {
            ...
            for(int i = 0 ; i < markerIds.size(); i++)
            {
                ...
                putText(image_raw_last_frame, "r(x): " + doubleToString(rvecs[i][0]* 180 / PI) , Point(markerCorners.at(i).at(1).x,markerCorners.at(i).at(1).y),FONT_HERSHEY_SIMPLEX, 0.8, Scalar(255,0,0), 2, LINE_8);
                putText(image_raw_last_frame, "r(y): " + doubleToString(rvecs[i][1]* 180 / PI) , Point(markerCorners.at(i).at(1).x,(markerCorners.at(i).at(1).y + 30)),FONT_HERSHEY_SIMPLEX, 0.8, Scalar(255,0,0), 2, LINE_8);
                putText(image_raw_last_frame, "r(z): " + doubleToString(rvecs[i][2]* 180 / PI) , Point(markerCorners.at(i).at(1).x,(markerCorners.at(i).at(1).y + 60)),FONT_HERSHEY_SIMPLEX, 0.8, Scalar(255,0,0), 2, LINE_8);

                putText(image_raw_last_frame, "t(x): " + doubleToString(tvecs[i][0]) , Point(markerCorners.at(i).at(1).x,(markerCorners.at(i).at(1).y + 90)),FONT_HERSHEY_SIMPLEX, 0.8, Scalar(255,0,0), 2, LINE_8);
                putText(image_raw_last_frame, "t(y): " + doubleToString(tvecs[i][1]) , Point(markerCorners.at(i).at(1).x,(markerCorners.at(i).at(1).y + 120)),FONT_HERSHEY_SIMPLEX, 0.8, Scalar(255,0,0), 2, LINE_8);
                putText(image_raw_last_frame, "t(z): " + doubleToString(tvecs[i][2]) , Point(markerCorners.at(i).at(1).x,(markerCorners.at(i).at(1).y + 150)),FONT_HERSHEY_SIMPLEX, 0.8, Scalar(255,0,0), 2, LINE_8);
        ...
        if(detected_marker_vec.size() != 0)
        {
            ...
            //marker_msg.markers_number = markercounter;
             ...
             for(int i = 0; i < detected_marker_vec.size(); i++)
             {
                ...
                cout <<"r(x) is: " << detected_marker_vec.at(i).rotvec_x * 180 / PI <<endl;
                cout <<"r(y) is: " << detected_marker_vec.at(i).rotvec_y * 180 / PI <<endl;
                cout <<"r(z) is: " << detected_marker_vec.at(i).rotvec_z * 180 / PI <<endl;
