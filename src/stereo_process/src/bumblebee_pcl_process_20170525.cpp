...
public:
                         ...
                         stereo_process::DepthRequest::Response &res)
    {
        ...
        {
            //ROS_INFO("Organized point cloud");
            point_depth = cloud->at(req.u,req.v).z;
            //ROS_ERROR("Point response:x:%f, y:%f, z:%f, req u:%d, req v:%d",cloud->at(req.u,req.v).x,cloud->at(req.u,req.v).y,cloud->at(req.u,req.v).z,req.u,req.v);
        }
