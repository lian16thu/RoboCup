...
"""autogenerated by genpy from vision/field.msg. Do not edit."""
import sys
...
class field(genpy.Message):
  _md5sum = "e7238b8238eb8992ed07002d15ada745"
  _type = "vision/field"
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_H().pack(self.width))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.width,) = _get_struct_H().unpack(str[start:end])
      start = end
      end += 4
