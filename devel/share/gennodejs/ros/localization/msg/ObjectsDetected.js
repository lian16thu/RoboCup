...
class ObjectsDetected {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ObjectsDetected(null);
  ...
  static datatype() {
    ...
    return 'localization/ObjectsDetected';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ObjectsDetected(null);
...
module.exports = ObjectsDetected;
