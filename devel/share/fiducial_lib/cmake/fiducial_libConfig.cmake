...
if(fiducial_lib_CONFIG_INCLUDED)
  return()
endif()
set(fiducial_lib_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(fiducial_lib_SOURCE_PREFIX /home/lian/robot_ws/src/fiducial_lib)
  set(fiducial_lib_DEVEL_PREFIX /home/lian/robot_ws/devel)
  set(fiducial_lib_INSTALL_PREFIX "")
  set(fiducial_lib_PREFIX ${fiducial_lib_DEVEL_PREFIX})
else()
  set(fiducial_lib_SOURCE_PREFIX "")
  set(fiducial_lib_DEVEL_PREFIX "")
  set(fiducial_lib_INSTALL_PREFIX /home/lian/robot_ws/install)
  set(fiducial_lib_PREFIX ${fiducial_lib_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'fiducial_lib' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(fiducial_lib_LIBRARY_DIRS ${lib_path})
      list(APPEND fiducial_lib_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'fiducial_lib'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND fiducial_lib_LIBRARIES ${lib})
    endif()
  endif()
...
set(fiducial_lib_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${fiducial_lib_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 fiducial_lib_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${fiducial_lib_dep}_FOUND)
      find_package(${fiducial_lib_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${fiducial_lib_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(fiducial_lib_INCLUDE_DIRS ${${fiducial_lib_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(fiducial_lib_LIBRARIES ${fiducial_lib_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${fiducial_lib_dep}_LIBRARIES})
  _list_append_deduplicate(fiducial_lib_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(fiducial_lib_LIBRARIES ${fiducial_lib_LIBRARIES})

  _list_append_unique(fiducial_lib_LIBRARY_DIRS ${${fiducial_lib_dep}_LIBRARY_DIRS})
  list(APPEND fiducial_lib_EXPORTED_TARGETS ${${fiducial_lib_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${fiducial_lib_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
